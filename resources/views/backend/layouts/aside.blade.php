                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                           aria-expanded="false"> <i class="menu-icon fa fa-cart-plus"></i>Products</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-cart-plus"></i><a href="ui-buttons.html">Category</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="ui-badges.html">All Products</a></li>
